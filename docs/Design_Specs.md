...
# Safety Features & PCB Test points
To ensure safe flight and integrity of drone, certain features are added and may or may not be toggle able(please consider each feature and what operations the drone might be involved in).

| Safety Feature   | Design Spec                                                                                                                                                                                                                                                                                                                                                                                                                                  | Implementation                                                                                                                        |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
